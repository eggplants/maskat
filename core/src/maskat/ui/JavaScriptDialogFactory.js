 ...
 */
/**
 * @class JavaScriptのダイアログ表示クラスのインスタンスを生成するためのクラスです。
 *
 * @name maskat.ui.JavaScriptDialogFactory
 * @extends maskat.ui.DialogFactory
 */
maskat.lang.Class.declare("maskat.ui.JavaScriptDialogFactory")
	.extend("maskat.ui.DialogFactory", {
	
	/** @scope maskat.ui.JavaScriptDialogFactory.prototype */
	...
	createConfirm: function (title, message, icon, onClick) {
		return new maskat.ui.JavaScriptConfirmDialog (title, message, icon, onClick);
	},
